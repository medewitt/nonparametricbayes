...
stan_all_fit_model <- cmdstan_model(hh("stan_all_code.stan"))


stan_next_fit_model <- cmdstan_model(hh("stan_next_code.stan"))


stan_kernel_fit_model <- cmdstan_model(hh("stan_kernel_code.stan"))


stan_kernel_cube_fit_model <- cmdstan_model(hh("stan_kernel_cube_code.stan"))
